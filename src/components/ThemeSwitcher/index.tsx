...
import {
  ...
  ColorSchemes,
  selectColorScheme
} from "@/redux-toolkit/slices/common/colorScheme/colorSchemeSlice";
import { useLocation } from "react-router-dom";
import { setTheme, themes, Themes } from "@/redux-toolkit/slices/theme/themeSlice";
import { selectDarkMode, setDarkMode } from "@/redux-toolkit/slices/common/darkMode/darkModeSlice";
  ...
  return (
    <div>
      ...
      {/* <div
        ...
        className="fixed bottom-0 right-0 z-30 flex items-center justify-center mb-5 mr-5 text-white rounded-full shadow-lg cursor-pointer w-14 h-14 bg-theme-1"
      >
